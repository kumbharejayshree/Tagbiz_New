...
public class AppConfig {
   ...
   //public static final String BASE_URL = "https://preprod.tagloy.com/v1/";
    ...
    public static final String GET_NOTICEBOARD_URL = BASE_URL + "live/tv/blackboard";
    public static final String UPDATE_NOTICEBOARD_URL = BASE_URL + "venue/blackboard/update";
